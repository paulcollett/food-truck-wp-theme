...
<div id="acf-upgrade-notice" class="acf-cf">
	...
	<div class="inner">
		...
		<div class="content">
			...
			<p><?php printf(__("Thank you for updating to %s v%s!", 'acf'), acf_get_setting('name'), acf_get_setting('version') ); ?><br /><?php _e("Before you start using the new awesome features, please update your database to the newest version.", 'food-truck'); ?></p>
